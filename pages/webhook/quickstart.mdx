...
To get started with using ABC Loyalty 3.0's event tracking API, you'll need to obtain your API key and webhook endpoint from the Dashboard | Developers | Webhook page. Once you have these, you can start sending data payloads to the SaaS server.
