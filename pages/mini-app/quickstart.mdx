...
1. Navigate to the Mini-app Settings page of the ABC Loyalty 3.0 Dashboard. 
![Dashboard-Settings-MiniApp](/dashboard-settings-miniapp.png)
2. Click the "Edit" link to set your authentication URL.
![Dashboard-Settings-MiniApp](/dashboard-settings-miniapp-credentials-edit.png)
3. Get the client key and client secret that you will use in the following steps.
![Dashboard-Settings-MiniApp](/dashboard-settings-miniapp-credentials.png)
